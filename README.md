...
<!-- BEGIN YOUTUBE-CARDS -->
#### [🔎 Forensics Analysis of a C2 Attack](https://github.com/faa-subsystem/C2_Attack_Investigation)
#### [🔎 RAM Forensics Analysis After Backdoor Attack with Volatility](https://github.com/faa-subsystem/RAM_Forensics_after_Backdoor_Attack)
#### [🐛 Pen-Testing Lab with VPN in Virtualbox](https://github.com/faa-subsystem/Pentesting_HomeLab_implementation_woth_virtualization/tree/main)
...
#### [📉 Automatizating system tasks with PowerShell](https://sites.google.com/view/faurys-portfolio/it-specialist#h.ql8okuqjx8iv)
